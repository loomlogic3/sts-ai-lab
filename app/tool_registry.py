...
def list_tools() -> list[dict]:
    ...
    return [
        ...
        {
            "name": "proposal",
            "command": "/proposal <goal>",
            "description": "Create a read-only change proposal.",
        },
        {
            "name": "propose-patch",
            "command": "/propose-patch <goal>",
        ...
        },
        {
            "name": "project-map",
            "command": "/project-map",
            "description": "Show a fast architecture map.",
        },
        {
            "name": "where",
